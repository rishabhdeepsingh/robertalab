...
/**
 * This class represents all methods which are connected to the native
 * counterpart CEF. The visibility of this class is "package". To create a new
...
abstract class CefBrowser_N extends CefNativeAdapter implements CefBrowser {
     ...
     */
    protected final void createDevTools(
        CefBrowser parent,
        CefClientHandler clientHandler,
        long windowHandle,
        boolean transparent,
     ...
     *
     * @param width
     *        The new width of the browser
     * @param height
     *        The new height of the browser
     */
     ...
     * CefRenderHandler::StartDragging). This method is only used when window
    ...
    /**
     * Call this method each time the mouse is moved across the web view during a
     * drag operation (after calling DragTargetDragEnter and before calling
     * DragTargetDragLeave/DragTargetDrop). This method is only used when window
     * rendering is disabled.
     */
     ...
     * calling DragTargetDragEnter). This method is only used when window rendering
     * is disabled.
     */
    ...
    /**
     * Call this method when the user completes the drag operation by dropping the
     * object onto the web view (after calling DragTargetDragEnter). The object
     * being dropped is |drag_data|, given as an argument to the previous
     * DragTargetDragEnter call. This method is only used when window rendering is
     * disabled.
     */
     ...
     * CefRenderHandler.startDragging call has ended either in a drop or by being
     * cancelled. |x| and |y| are mouse coordinates relative to the upper-left
     * corner of the view. If the web view is both the drag source and the drag
     * target then all DragTarget* methods should be called before DragSource*
     * methods. This method is only used when window rendering is disabled.
     */
    ...
    /**
     * Call this method when the drag operation started by a
     * CefRenderHandler.startDragging call has completed. This method may be called
     * immediately without first calling DragSourceEndedAt to cancel a drag
     * operation. If the web view is both the drag source and the drag target then
     * all DragTarget* methods should be called before DragSource* methods. This
    ...
    private final native boolean N_CreateDevTools(
        CefBrowser parent,
        CefClientHandler clientHandler,
        long windowHandle,
        boolean transparent,
